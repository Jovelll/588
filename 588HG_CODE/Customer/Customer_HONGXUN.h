...
#ifndef _CUSTOMER_HONGXUN_H_
#define _CUSTOMER_HONGXUN_H_

#define MainBoardType     MainBoard_TSUMP589MG_H // MainBoard_TSUMO58FDT9_VSP58C31_3_IN_1   


#define PanelType               PanelBOEMV238FHM_N30//PanelM185BGE_L22//PanelM190A1L02    

//#define  HOTKEY_TYPE                    HOTKEY_XYD_5KEY 
#define DisplayLogo             SUGON//NoBrand//      
#define Enable_AdjustDCR         0
#define LowBlueLight      0//  1


#define Def_CTEMP				      CTEMP_6500K
#define LANG_Default			   HKC_LANG_SimChinese//HKC_LANG_Portuguese//HKC_LANG_English //   
...
#define MidDutyValue   	120//	      
#define MaxDutyValue   	201//2//301 

#define DefBrightness   80//100
