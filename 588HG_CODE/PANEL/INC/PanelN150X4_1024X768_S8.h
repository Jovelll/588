#ifndef __PANELN150X4_1024X768_S8_H__
#define __PANELN150X4_1024X768_S8_H__
#define PanelNumber             1800
#define PanelName               "N150X4"
...
#define PanelOnTiming1		30//30//90   //time between panel & data while turn on power
#define PanelOnTiming2		400//520+60 //time between data & back light while turn on power 
#define PanelOffTiming1		80 //time between back light & data while turn off power 
#define PanelOffTiming2		30   //time between data & panel while turn off power 
#define PanelOffTiming0 		1100 // time between 12V - 3.3V
#define PanelHSyncWidth        20// 40
#define PanelHSyncBackPorch 	40
#define PanelVSyncWidth         4//6
#define PanelVSyncBackPorch 	34//21
#define PanelHStart     (PanelHSyncWidth+PanelHSyncBackPorch)
#define PanelVStart     (PanelVSyncWidth+PanelVSyncBackPorch)
#define PanelWidth      1024
#define PanelHeight     768
#define PanelHTotal			2200//2200
#define PanelVTotal			1150//1125
#define PanelMaxHTotal		2600//2240
#define PanelMinHTotal		1500//2100   
#define PanelMaxVTotal		1350//1251
#define PanelMinVTotal		1100//1100
#define PanelDCLK			65//148
#define PanelMaxDCLK		67//200
#define PanelMinDCLK		50//80
