#ifndef __PANEL_CMO215HGE_H__
#define __PANEL_CMO215HGE_H__
#define PanelNumber             1800
#define PanelName               "CMO215HGE"
...
#define PanelOnTiming1      60 //80 // time between panel & data while turn on power
#define PanelOnTiming2      600 //80 // time between data & back light while turn on power 
#define PanelOffTiming1     300 //250 //80 // time between back light & data while turn off power 
#define PanelOffTiming2     30 //5 //80 // time between data & panel while turn off power 
#define PanelOffTiming0 0 // time between 12V - 3.3V
#define PanelHSyncWidth     32//42  //2004/01/30 num2 old:51
#define PanelHSyncBackPorch 80//30  //2004/01/30 num2 old:21
...
#define PanelMaxVTotal      1600///1136 if support Freesync, please modify panel MaxVtotal. MaxVtotal=MaxDCLK/MinVFreq/MinHtotal(EX:196000000/50/2110)
#define PanelMinVTotal      1115
#define PanelDCLK              148
#define PanelMaxDCLK        196  //2004/01/13 num1
