...
#define PanelHSyncWidth     36///10///48//36 //32
#define PanelHSyncBackPorch 80///8///80//40

#define PanelVSyncWidth     5
#define PanelVSyncBackPorch 18//23

#define PanelHStart     (PanelHSyncWidth+PanelHSyncBackPorch)
#define PanelVStart     (PanelVSyncWidth+PanelVSyncBackPorch)
#define PanelWidth      1920
#define PanelHeight     1080
#define PanelHTotal     2104
#define PanelVTotal     1116

#define PanelMaxHTotal      2320
#define PanelMinHTotal      2000
#define PanelMaxVTotal      1125//3080
