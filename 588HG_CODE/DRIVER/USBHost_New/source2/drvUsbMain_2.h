...
extern U16  gUTMI2_BASE;
extern U16  gUSBC2_BASE;

#define  UHC_XBYTE(x)       (XBYTE[gUHC2_BASE+x])
#define  UTMI_XBYTE(x)       (XBYTE[gUTMI2_BASE+x])
#define  USBC_XBYTE(x)       (XBYTE[gUSBC2_BASE+x])
