...
extern U32 USB_BUFFER_START_ADR_4K_ALIGN_Var;
...
//========================================================================================================
 ...
 //  #if (USB_BUFFER_START_ADR_4K_ALIGN % 4096 != 0)
  ...
  // #endif
	...
	#else
//    #define XDATA_USB_ADDR_START    0x4780    see  "msFB_D.h"
	#define Host20_STRUCTURE_BASE_ADDRESS	        0xE000//0x4900//0x4DC0//0x4780//0xE000//SDRAM start at 60K
	#endif
	...
	#define Host20_qHD_SIZE	                        0x40//(64bytes), for alignment
...
#if 0   // use the define in DataType.h
...
//	#define mwHost20Port(bOffset)	                  *((UINT8 volatile  xdata *) ( Host20_BASE_ADDRESS | bOffset))
	#define mwHost20Port(bOffset)	                  *((UINT8 volatile  xdata *) ( gUHC_BASE | bOffset))
...
//	#define mwHost20_USBSTS_HCHalted_Rd()		              (mwHost20Bit_Rd(0x14,BIT12)) 	//Bit 12
	...
	#define mwHost20_PeriodicBaseAddr_Set(wValue)		      USB_Write_REG32(0x24,wValue)
	...
	#define mwHost20_CurrentAsynchronousAddr_Set(wValue)	  USB_Write_REG32(0x28,wValue)
...
#ifdef USE_XDATA_ADDRESS_0XF000
#define  VirtoPhyAddr(x)            (x-0xf000+USB_BUFFER_START_ADR_4K_ALIGN_Var)
#define  PhytoVirAddr(x)            (x-USB_BUFFER_START_ADR_4K_ALIGN_Var+0xf000)
#else
#define  VirtoPhyAddr(x)            (x+USB_BUFFER_START_ADR_4K_ALIGN_Var)
#define  PhytoVirAddr(x)            (x-USB_BUFFER_START_ADR_4K_ALIGN_Var)
#endif
#define flib_Host20_Allocate_QHD_Macro(x,y,z,w,u,v)                 \
   {  x->bType=y;                                       \
       ...
       x->bMaxPacketSize=v;          }
#if 0
#define flib_Host20_Allocate_QHD(x,y,z,w,u,v)                           \
{                                                                                                     \
    flib_Host20_Allocate_QHD_Macro(x,y,z,w,u,v) ;                  \
    flib_Host20_Allocate_QHD1(x);  }
#endif
...
//========================================================================================================
  ...
  extern BOOLEAN flib_OTGH_Init(UINT8 wForDevice_B);
  extern UINT8 flib_Host20_Close();
 extern BOOLEAN USB_Hub_Handle(U8 port)	;
extern U8 Usb_Hub_Port_Num(void);

  //extern UINT8 flib_Host20_ISR(void);
  extern UINT8 flib_Host20_PortBusReset(void);
  extern void flib_Host20_Suspend(void);
  extern UINT8 flib_Host20_Issue_Control (UINT8 bEdNum,UINT8* pbCmd,UINT16 hwDataSize,UINT8* pbData);
  extern UINT8  flib_Host20_Issue_Bulk(UINT8 bArrayListNum,UINT16 hwSize,UINT32,UINT8 bDirection);
...
//  extern void flib_Host20_TimerEnable(UINT32 wTime_ms);
  ...
  extern UINT16 flib_Host20_GetStructure(UINT8 Type);
  extern void flib_Host20_ReleaseStructure(UINT8 Type,UINT16 pwAddress);
  extern void flib_Host20_QHD_Control_Init(void);
  extern void flib_Host20_Allocate_QHD1(qHD_Structure  *psQHTemp);
  extern UINT8 flib_Host20_Send_qTD(qTD_Structure *spHeadqTD ,qHD_Structure *spTempqHD,U16 wTimeOutSec);  
  extern UINT8 flib_Host20_Send_qTD_Int_Pipe(qTD_Structure *spHeadqTD ,qHD_Structure *spTempqHD,U16 wTimeOutSec,U8 u8Interface);
...
extern MStar_Prepare_QHD(UINT16 pQHTemp,UINT8 bNextType,UINT8 bAddress,UINT8 bHead,UINT8 bEndPt, UINT16 wMaxPacketSize);
  ...
  extern void  flib_Host20_Interrupt_Init(UINT8 bAddr, U8 u8Interface, U8 QH_number);
extern void  flib_Host20_Issue_Interrupt(UINT16 buf,UINT16 hwSize, U8 u8Interface);
extern void  flib_Host20_Issue_Interrupt_qh2(UINT16 buf,UINT16 hwSize, U8 u8Interface);
...
//   extern void flib_Host20_TimerDisable_UnLock(void);
  ...
  //  extern void SetPointer(UINT16 addr, UINT32 val);
...
void FillBufferArray(qTD_Structure xdata  *spTempqTD,UINT16        bpDataPage);
 extern void FillBufferArray2(qTD_Structure xdata *spTempqTD, UINT32 bpDataPage,UINT16 size);

//void SetPointer( qHD_Structure  xdata *qhd, UINT32 val);
...
//========================================================================================================
 ...
 extern  code UINT8 OTGH_GETDESCRIPTOR_DEVICE[];
 extern  code UINT8 OTGH_GETDESCRIPTOR_CONFIG[];
 extern  code UINT8 OTGH_SETADDRESS[];
 extern  code  UINT8 OTGH_SETCONFIGURATION[];
...
extern  qHD_Structure xdata Host20_qHD_List_Control0;
extern  qHD_Structure xdata Host20_qHD_List_Control1;
#ifdef Enable_Mass_Storage
extern  qHD_Structure xdata Host20_qHD_List_Bulk0;
extern  qHD_Structure xdata Host20_qHD_List_Bulk1;
#endif
