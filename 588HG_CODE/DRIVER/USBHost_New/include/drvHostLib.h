...
//  extern void flib_Host20_TimerEnable(UINT32 wTime_ms);
  ...
  extern UINT8 flib_Host20_Send_qTD_Int_Pipe(qTD_Structure *spHeadqTD ,qHD_Structure *spTempqHD,U16 wTimeOutSec);
...
extern MStar_Prepare_QHD(UINT16 pQHTemp,UINT8 bNextType,UINT8 bAddress,UINT8 bHead,UINT8 bEndPt, UINT16 wMaxPacketSize);
  ...
  extern void  flib_Host20_Interrupt_Init(UINT8 bAddr);
extern void  flib_Host20_Issue_Interrupt(UINT16 buf,UINT16 hwSize);
