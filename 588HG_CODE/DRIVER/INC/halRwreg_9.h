...
#define ICE_BRIGHTNESS_RGBCMY(Value)    msWriteByte(SC9_1A, Value);msWriteByte(SC9_1B, Value);msWriteByte(SC9_1C, Value);\
										msWriteByte(SC9_1D, Value);msWriteByte(SC9_1E, Value);msWriteByte(SC9_1F, Value)
