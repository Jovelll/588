...
// DDC mode selection
#define D2BModeSel  D2BMode_FIFO_Normal_XSharedAll // Be aware of buffer overflow problem, MUST reserved enough buffer size!!!!!
...
#define D2B_FIFO_Enhance        (0&D2B_FIFO_Mode)
...
#define D2B_SET_FIFOMODE_XDATAMAP_VGA(XdataAddressStart)    (msWrite2ByteMask(REG_3EE8, XdataAddressStart-XDATA_ADDR_START, 0x0FFF)) // DDC_xdata mapping address
...
#define D2B_SET_FIFOMODE_XDATAMAP_D0(XdataAddressStart)     (msWrite2ByteMask(REG_3ECA, XdataAddressStart-XDATA_ADDR_START, 0x0FFF)) // DDC_xdata mapping address
...
#define D2B_SET_FIFOMODE_XDATAMAP_D1(XdataAddressStart)     (msWrite2ByteMask(REG_3ED0, XdataAddressStart-XDATA_ADDR_START, 0x0FFF)) // DDC_xdata mapping address
