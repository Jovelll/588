...
#define DVI_RELATED_CLOCK_CTRL_0(Value, Mask)    (msWrite2ByteMask( REG_174C, Value, Mask ))
#define DVI_RELATED_CLOCK_CTRL_1(Value, Mask)    (msWrite2ByteMask( REG_174E, Value, Mask ))
#define DVI_DE_STABLE()  (  (msReadByte( REG_155D) & (BIT6|BIT5))== BIT6) // DE stable
#define DVI_CLK_STABLE()  (  (msReadByte( REG_165C) & (BIT3))== BIT3) // CLK stable
...
// dp
#define DP_INTERLACED_VIDEO_STREAM()    (msReadByte( REG_136B ) & BIT2)
