...
#define INT_IRQ_DVI_ENABLE(Enable)    (msWriteByteMask( REG_2B19, ((Enable)?(0):(BIT6)), BIT6 ))
...
// hdcp
#define HDCP_PORT_ENABLE()  // none
#define HDCP_PORT_DISABLE()  // none
...
#define HDCP_ENABLE_DDC()   (msWriteByteMask( REG_3E74, BIT5, BIT5 ))
...
#define DVI_DE_STABLE()  ( ( msReadByte( REG_282D ) & (BIT0|BIT1) ) == 0x02 ) // V
...
#define OSD_TEXT_HI_ADDR_SET_BIT8()     msWriteByteMask(OSD1_69, BIT0, BIT1|BIT0); //enable bit 8
#define OSD_TEXT_HI_ADDR_SET_BIT9()     msWriteByteMask(OSD1_69, BIT1, BIT1|BIT0); //enable bit 9
#define OSD_TEXT_HI_ADDR_CLR_TO_0()     msWriteByteMask(OSD1_69,    0, BIT1|BIT0);
