...
#ifndef _drvDPRXAPP_9_H_
#define _drvDPRXAPP_9_H_
...
//===============================================
#define DP_AUX_NORMAL_FRO		                   1    // if 1:  Use Fro       if 0:  Xstal
#define DP_EDID_384						    0
#define DP_AUTOEQ						    1
#define DP_AUTOCR						    1
#define DP_INTERSKEWMORE                            (CHIP_ID==CHIP_TSUM9)
//==============================================
//			      For test  :   Keep  0  in your code
//==============================================
...
//=======================================================================
#define HW_SET_AUDIO_MUTE_ENABLE()		     msWriteByteMask(REG_1AC0,_BIT4,_BIT4);
                                                                                 


#define HW_SET_AUDIO_MUTE_DISABLE()	            msWriteByteMask(REG_1AC0,0,_BIT4);
...
#define DPRxAsynReset()								 (msWriteByteMask(REG_18FE, BIT5, BIT5));\                                             
                                                                                            (msWriteByteMask(REG_18FE, 0, BIT5));\
													 (msWriteByteMask(REG_061E, BIT1, BIT1));\                                             
                                                                                            (msWriteByteMask(REG_061E, 0, BIT1));
...
#define Set_DPAutoSythNewMode()			   	        (MEM_MSWRITE_BYTE_MASK(REG_1BBE,BIT4,BIT4));
#define Clr_DPAutoSythNewMode()						 (MEM_MSWRITE_BYTE_MASK(REG_1BBE,0,BIT4));
#endif


extern BYTE xdata DDCData[16] ;
#if 0
...
#endif
extern void DPRxEFuseInit();
extern void DPRxPower5VEnable(Bool bEnable);
extern void DPRXAutoEQCheck( void );
...
extern void DPRxSetAuxClock(DP_AuxClock temp);
...
extern void DPRxPHYInit(void);
extern void DPRxMACInit(void);
extern void DPRxAudioInit(void);  
extern void DPRxProgramDPCDInit(void);
extern void DPRxAutoEQInit();
extern void DPRXGetPktStatus(void);
extern void DPRxInitVariable( void );
extern void DP_EnableSquelch(Bool bEnable);
extern Bool DP_GetSquelch(DWORD Times); 
extern void DPRxCDRLossHander(void);
extern Bool DPRXCheckDPMS(void);
#if DP_VPLLBIGChange
