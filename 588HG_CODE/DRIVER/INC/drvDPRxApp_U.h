...
_DPRXAPP_DEC_ WORD _DPDATATYPE_ Aux;
...
#define DP_USE_INTERNAL_EDID                  1///  0
#define DP_USE_INTERNAL_HDCP                  0
#define DP_ASTRO_INTERLACE_PATCH              0
//===============================================
...
#define DPINPUT_COLORSPACEYUV()                     (((gDPInfo.ucDPColorFormat&(_BIT1|_BIT0)))!=InputColor_RGB)
