...
#ifndef _DRV_CEC_C_H_
#define _DRV_CEC_C_H_

#if ENABLE_CEC
#include "apiCEC.h"

#ifdef _DRV_CEC_C_
    #define _DRV_CEC_C_DEF_
#else
    #define _DRV_CEC_C_DEF_ extern
#endif
...
_DRV_CEC_C_DEF_ stDRV_CEC_INFO xdata gStCECInfo;

//***********************************************************************************
//  Function Prototype
//***********************************************************************************
_DRV_CEC_C_DEF_ void drv_CEC_Init(void);
_DRV_CEC_C_DEF_ void drv_CEC_CheckExistedDevice(void);
_DRV_CEC_C_DEF_ void drv_CEC_CheckRxBuffer(void);
_DRV_CEC_C_DEF_ void drv_CEC_CheckRxBuffer(void);
_DRV_CEC_C_DEF_ enMsCEC_INT_EVENT drv_CEC_ProcessTX(enMsCEC_DEV_LOGIC_ADDR dst_addr, enMsCEC_OPCODE_LIST msg, BYTE* operand_ptr, BYTE len);
_DRV_CEC_C_DEF_ BOOL drv_CEC_CheckFrame(enMsCEC_MSGTRANS_TYPE MsgType, BYTE length );
