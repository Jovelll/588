...
#define MHL_PHASE_PATH_I                1
#define MHL_PHASE_PATH_II               2
#define MHL_PHASE_CHECK_PATCH           MHL_PHASE_PATH_II
...
#define MHL_CDR_PHASE_CODE              0x189

#if(MHL_PHASE_CHECK_PATCH)
#define MHL_PHASE_CODE_NUM              40
#define MHL_PHASE_CHANGE_MASK           200
#define MHL_PHASE_CHECK_INTERVAL        5   // 1ms one unit
#define MHL_PHASE_POLLING_INTERVAL      100//20   // 1ms one unit
#define MHL_PHASE_JUMP_STEP             20

#if(MHL_FORCE_VCO_LOOP_DEV2)
#define MHL_PHASE_CODE_MARGIN           26
#define MHL_PHASE_CHECK_STEP            4

#else
#define MHL_PHASE_CODE_MARGIN           50
#define MHL_PHASE_CHECK_STEP            4
#define MHL_PHASE_TOLERANCE             10
#endif

#define MHL_PHASE_CHECK_GAIN            ((MHL_PHASE_CODE_MARGIN /MHL_PHASE_CODE_NUM) +1)

extern bit idata bCDRTimerFlag;
extern BYTE idata ucCDRTimerCnt;
extern BYTE xdata ucCableDetectEnable;

#define GET_PHASE_CHECK_TIMER()         (bCDRTimerFlag)
#define SET_PHASE_CHECK_TIMER(a)        (bCDRTimerFlag = FALSE, ucCDRTimerCnt = a, bCDRTimerFlag = TRUE)
...
#if(MHL_PHASE_CHECK_PATCH)
enum MHL_PHASE_CHECK_TYPE
{
    MHL_PHASE_CHECK_START = 0,
    MHL_PHASE_WAIT_ERROR,
    MHL_PHASE_ERROR_HAPPEN,
    MHL_PHASE_CHECK_POLLING,
    MHL_PHASE_CHECK_FINISH,
};
