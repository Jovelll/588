...
_DRV_CEC_DEF_ stDRV_CEC_INFO xdata gStCECInfo;

//***********************************************************************************
//  Function Prototype
//***********************************************************************************
_DRV_CEC_DEF_ void drv_CEC_Init(void);
_DRV_CEC_DEF_ void drv_CEC_CheckExistedDevice(void);
_DRV_CEC_DEF_ void drv_CEC_CheckRxBuffer(void);
_DRV_CEC_DEF_ void drv_CEC_CheckRxBuffer(void);
_DRV_CEC_DEF_ enMsCEC_INT_EVENT drv_CEC_ProcessTX(enMsCEC_DEV_LOGIC_ADDR dst_addr, enMsCEC_OPCODE_LIST msg, BYTE* operand_ptr, BYTE len);
_DRV_CEC_DEF_ BOOL drv_CEC_CheckFrame(enMsCEC_MSGTRANS_TYPE MsgType, BYTE length );
