...
DWORD code g_mcuPLLFreqTable[] =
{
    ...
    CLOCK_144MHZ,		   // 3,
    CLOCK_108MHZ,          // 4,
    CLOCK_86MHZ,           // 5,   mem_clock
    CLOCK_54MHZ,           // 6,   mem_clock/2
    CLOCK_27MHZ,           // 7,
    CLOCK_XTAL,            // 8
};
...
#endif
#if IR_FUNC_EN
// u16Divider0 = ( 65536 - ( u32Freq * INT_PERIOD + 6 ) / 12 / 5 + IR_FREQ_FINETUNE   ); // 200uS
  u16Divider0 = ( 65536 - ( u32Freq * INT_PERIOD + 6 ) / 12/5    ); // 200uS
    g_ucTimer1_TH0 = HIBYTE( u16Divider0 );
    g_ucTimer1_TL0 = LOBYTE( u16Divider0 );
    TH1=g_ucTimer1_TH0;  //200us reload
    TL1=g_ucTimer1_TL0;  //200us reload 
 #endif
