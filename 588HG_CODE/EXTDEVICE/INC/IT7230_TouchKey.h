...
#define STATUS_INVALID          0xFFFF
#define ITEKEY_POLLING_TIMER    80//ms
#define ITEKEY_CHECKESD_TIMER   2000//ms
#if  ENABLE_LOW_CONTACT
#define ITEKEY_LOWCONTACT_TIMER 20000//ms
#endif
    ...
    #undef IT7230BFN
        ...
        #define LED_8    _BIT8
        #define LED_9    _BIT9
        #define LED_10   _BIT10
        #define LED_11   _BIT11
        #define LED_12   _BIT12
    #endif
#endif
    ...
    #undef IT7230AFN
        ...
        #define LED_9    _BIT9
        #define LED_11   _BIT11
        #define LED_14   _BIT14
    #endif
#endif

#define TPREG_POWER                 0x08
#define TPREG_MENU                  0x10
#define TPREG_PLUS                  0x20
#define TPREG_MINUS                 0x01
#define TPREG_AUTO                  0x02
#define TPREG_INPUT                 0x40
#define TPREG_FACTORY              (TPREG_PLUS|TPREG_MINUS|TPREG_POWER)// (TPREG_MENU|TPREG_MINUS|TPREG_POWER)
#define TPREG_OSDLOCK               (TPREG_MENU|TPREG_POWER)
#define TPREG_KEYPADMASK        ( TPREG_POWER | TPREG_MENU | TPREG_MINUS | TPREG_PLUS | TPREG_AUTO | TPREG_INPUT )
...
#endif
#endif//#ifndef _IT7230_TouchKey_H
