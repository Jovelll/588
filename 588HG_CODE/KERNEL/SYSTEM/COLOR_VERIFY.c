...
#define NO_CHANGE_SHARPNESS 0xFF
    ...
    for( uci = 0; uci < 8; uci ++ )
    {
         msWriteByteMask(SCB_40+uci, 0x00,0xFF);        //overshoort：SCB_40~SCB_47
         msWriteByteMask(SCB_48+uci, 0xFF,0xFF);        //undershoort：SCB_48~SCB_4F
    }
...
*/
    ...
    msWriteByteMask(SC4_20,	u8Enable	,BIT7|BIT0);  //BIT0:enable ,BIT7：debug mode
