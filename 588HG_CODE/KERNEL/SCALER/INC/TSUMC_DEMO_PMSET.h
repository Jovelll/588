...
#define PM_CLOCK              XTAL//  RCOSC   //modified clock rate on PM mode - A059
...
#define PM_POWERSAVING_WAKEUP_SAR               0 // 1 130415 coding modified for MHL cable detect use sar
