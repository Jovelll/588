...
#define PM_CLOCK                RCOSC//XTAL     //111110 modified VS230 PM mode Clock speed 
...
#define EN_PMGPIO00_DET      _BIT0      // enable wakeup detect of PM GPIO 00
#define EN_PMGPIO01_DET      _BIT1      // enable wakeup detect of PM GPIO 01
#define EN_PMGPIO02_DET      _BIT2      // enable wakeup detect of PM GPIO 02
#define EN_PMGPIO03_DET      _BIT3      // enable wakeup detect of PM GPIO 03
#define EN_PMGPIO04_DET      _BIT4      // enable wakeup detect of PM GPIO 04
#define EN_PMGPIO05_DET      _BIT5      // enable wakeup detect of PM GPIO 05
#define EN_PMGPIO06_DET      _BIT6      // enable wakeup detect of PM GPIO 06
#define EN_PMGPIO07_DET      _BIT7      // enable wakeup detect of PM GPIO 07
#define EN_PMGPIO24_DET      _BIT8      // enable wakeup detect of PM GPIO 24
#define EN_PMGPIO25_DET      _BIT9      // enable wakeup detect of PM GPIO 25
#define EN_PMGPIO26_DET      _BIT10     // enable wakeup detect of PM GPIO 26
#define EN_PMGPIO27_DET      _BIT11     // enable wakeup detect of PM GPIO 27

#define REG_PMGPIO_POL       REG_PM_62  // use word access to this register
#define INV_PMGPIO00_POL     _BIT0      // invert input signal polarity of PM GPIO 00
#define INV_PMGPIO01_POL     _BIT1      // invert input signal polarity of PM GPIO 01
#define INV_PMGPIO02_POL     _BIT2      // invert input signal polarity of PM GPIO 02
#define INV_PMGPIO03_POL     _BIT3      // invert input signal polarity of PM GPIO 03
#define INV_PMGPIO04_POL     _BIT4      // invert input signal polarity of PM GPIO 04
#define INV_PMGPIO05_POL     _BIT5      // invert input signal polarity of PM GPIO 05
#define INV_PMGPIO06_POL     _BIT6      // invert input signal polarity of PM GPIO 06
#define INV_PMGPIO07_POL     _BIT7      // invert input signal polarity of PM GPIO 07
#define INV_PMGPIO24_POL     _BIT8      // invert input signal polarity of PM GPIO 24
#define INV_PMGPIO25_POL     _BIT9      // invert input signal polarity of PM GPIO 25
#define INV_PMGPIO26_POL     _BIT10     // invert input signal polarity of PM GPIO 26
#define INV_PMGPIO27_POL     _BIT11     // invert input signal polarity of PM GPIO 27

#define REG_PMGPIO_STS       REG_PM_64   // use word access to this register
#define PMGPIO00_INT         _BIT0      // wakeup status of PM GPIO 00
#define PMGPIO01_INT         _BIT1      // wakeup status of PM GPIO 01
#define PMGPIO02_INT         _BIT2      // wakeup status of PM GPIO 02
#define PMGPIO03_INT         _BIT3      // wakeup status of PM GPIO 03
#define PMGPIO04_INT         _BIT4      // wakeup status of PM GPIO 04
#define PMGPIO05_INT         _BIT5      // wakeup status of PM GPIO 05
#define PMGPIO06_INT         _BIT6      // wakeup status of PM GPIO 06
#define PMGPIO07_INT         _BIT7      // wakeup status of PM GPIO 07
#define PMGPIO24_INT         _BIT8      // wakeup status of PM GPIO 24
#define PMGPIO25_INT         _BIT9      // wakeup status of PM GPIO 25
#define PMGPIO26_INT         _BIT10     // wakeup status of PM GPIO 26
#define PMGPIO27_INT         _BIT11     // wakeup status of PM GPIO 27
...
#define PM_DPCBL_DET             INV_PMGPIO00_POL
//----------------------------------------
