...
BYTE code  EDID[256] =
{
...
#if 0// For Nvidia EDID 1080P120hx
    ...
    #endif
	#if 0//DELL_1680X1050 // 20111007.  Gary.Wang 
...
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00
    ...
    #endif	
#if 1 //TPV VS230PGLW // 20111007.  Gary.Wang 
...
void DPRxInit( void )
{
    ...
    msWriteByteMask( REG_3681, BIT3 | BIT2, BIT3 | BIT2 );
...
//
//**************************************************************************
void DPRxDCHPD( Bool enable )  // 2011-08-08 Ivan.Kao
{
    //printData( "[DPRxDCHPD=%x", enable );
    if( enable )
    {
        //msWriteByte(BKB_A1, mStar_ReadByte(BKB_A1)|BIT5);
        msWriteByte( REG_0226, msReadByte( REG_0226 )&( ~_BIT2 ) ); //  HPD ouput enable and set low
    }
    else
    {
        //mStar_WriteByte2(BKB_A1, mStar_ReadByte2(BKB_A1)&~BIT5);
        msWriteByte( REG_0226, msReadByte( REG_0226 ) | _BIT2 ); //  HPD ouput enable and set low
        ForceDelay1ms( 60 );
    }
}
    ...
    if(( msRegs[REG_1FE4] & 0x01 ) || ( msRegs[REG_1FE8] & 0x01 ) )    // Training P1
    {
	 ...
	 if(msRegs[REG_1F0E] ==0x14)
       ...
       if(msRegs[REG_1F0E] !=0x14)
       {
        ...
        while((( msRegs[REG_1FE4] & 0x03 ) == 0x01 ) && ( DPTP1Cnt < 50000 ) ) // while pattern 1 is On-Going
        {
            if(DPTP1Cnt > 49990)
...
#endif
BYTE code DPRxApp_DummyCode[] = {NULL};
#endif
