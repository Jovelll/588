...
#define PowerKey                (_bit1_(MEM_MSREAD_BYTE(_REG_GPIO0_IN)))
...
#define hw_SetPanel()           MEM_MSWRITE_BIT(_REG_GPIO2_OUT, 0, BIT1)  //ok
#define hw_ClrPanel()           MEM_MSWRITE_BIT(_REG_GPIO2_OUT, 1, BIT1)   //ok
