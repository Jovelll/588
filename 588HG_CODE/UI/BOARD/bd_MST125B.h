...
#define HDMI_PORT               TMDS_PORT_A
#define HDMI_HPD_PORT           TMDS_PORT_A
#define HDMI_DDC_PORT           TMDS_PORT_A
...
#define hw_SetFlashWP()         MEM_MSWRITE_BIT(_REG_PMGPIO0_OUT, 1, BIT7)
#define hw_ClrFlashWP()         MEM_MSWRITE_BIT(_REG_PMGPIO0_OUT, 0, BIT7)
...
#define hw_SetPanel()       MEM_MSWRITE_BIT(_REG_GPIO2_OUT, 0, BIT6)
#define hw_ClrPanel()       MEM_MSWRITE_BIT(_REG_GPIO2_OUT, 1, BIT6)//(_REG_GPIO1_OUT, 0, BIT2)
