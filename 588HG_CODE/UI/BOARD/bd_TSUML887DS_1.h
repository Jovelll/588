...
#if AudioFunc
#define VolumePWM               _PWM5_// Not Finishhed Yet in CHIP_TSUMD
...
#define Set_EEPROM_WP()         MEM_MSWRITE_BIT(_REG_GPIO5_OUT, 1, BIT1)
#define Clr_EEPROM_WP()         MEM_MSWRITE_BIT(_REG_GPIO5_OUT, 0, BIT1)
...
#define hwBlacklit_Pin          //GPIO27  //Driving Non-LED BL Module
#define hwPanel_Pin             //GPIO30
...
#define hw_SetPanel()           MEM_MSWRITE_BIT(_REG_GPIO3_OUT, 0, BIT0)
#define hw_ClrPanel()           MEM_MSWRITE_BIT(_REG_GPIO3_OUT, 1, BIT0)
#define Init_hwPanel_Pin()      MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, 0, BIT0) // output enable
...
#if ENABLE_HDCP
#define hwHDCP_Hpd_Pin //GPIO36 = Port B (channel 0), GPIO31 = Port A
#if HPD_INVERSE
...
// MHL PS_CTRL
#define SET_MHL_PS_CTRL_CHARGE0()    (MEM_MSWRITE_BIT(_REG_GPIO5_OEZ, TRUE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO5_OUT, TRUE, BIT2))
#define CLR_MHL_PS_CTRL_CHARGE0()    (MEM_MSWRITE_BIT(_REG_GPIO5_OEZ, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO5_OUT, FALSE, BIT2))
