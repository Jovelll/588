...
// MHL PS_CTRL
#define SET_MHL_PS_CTRL_CHARGE0()    (MEM_MSWRITE_BIT(_REG_GPIO2_OUT, TRUE, BIT1), MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, FALSE, BIT1))
#define CLR_MHL_PS_CTRL_CHARGE0()    (MEM_MSWRITE_BIT(_REG_GPIO2_OUT, FALSE, BIT1), MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, FALSE, BIT1))
