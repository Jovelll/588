...
#define hw_SetDDC_WP()          MEM_MSWRITE_BIT(_REG_GPIO3_OUT, 1, BIT6)       // HDMI-DDC
#define hw_ClrDDC_WP()           MEM_MSWRITE_BIT(_REG_GPIO3_OUT, 0, BIT6)
#define Init_hwDDC_WP_Pin()   MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, 0, BIT6)   
...
#define INIT_HW_HarphoneDet_PIN()    	(MEM_MSWRITE_BIT(_REG_GPIO5_OEZ, 1, BIT1),MEM_MSWRITE_BIT(_REG_GPIO5_OEZ, 1, BIT0))
#define HarphoneDet_Pin                             ((_bit1_(MEM_MSREAD_BYTE(_REG_GPIO5_IN)))||(_bit0_(MEM_MSREAD_BYTE(_REG_GPIO5_IN))))
#define hw_Earphone_SetMute()                    (MEM_MSWRITE_BIT(_REG_GPIO0_OUT, 0, BIT2))
#define hw_Earphone_ClrMute()                     (MEM_MSWRITE_BIT(_REG_GPIO0_OUT, 1, BIT2))
#define Init_Earphone_hwMute_Pin()             (MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, 0, BIT2))
#endif
//================================================================================================================


#ifndef LEDBLModule_OnMainBoard
...
#if LEDBLModule_OnMainBoard     
     #define hw_SetBlacklit()                (MEM_MSWRITE_BIT(_REG_GPIOL_OUT_H, 1, BIT3), BackLightActiveFlag=1)    
     #define hw_ClrBlacklit()                (MEM_MSWRITE_BIT(_REG_GPIOL_OUT_H, 0, BIT3), BackLightActiveFlag=0)
#else
...
#endif
#define Init_hwBlacklit_Pin()           (MEM_MSWRITE_BIT(_REG_GPIOL_OEZ_H, 0, BIT3),MEM_MSWRITE_BIT(_REG_GPIOL_SEL_H, 0, BIT3))//,MEM_MSWRITE_BIT(REG_0262, FALSE, BIT5))// output enable

#define hw_SetPanel()                  MEM_MSWRITE_BIT(_REG_GPIOL_OUT_H, 1, BIT0)   //---tang
...
#else
#define hwDSUBCable_Pin                 (_bit2_(MEM_MSREAD_BYTE(_REG_GPIO5_IN)))  //SAR3
#define Init_hwDSUBCable_Pin()          (MEM_MSWRITE_BIT(_REG_GPIO5_OEZ, 1, BIT2))
#define CABLE_DET_VGA_SAR               0
#endif


#if (CInput_HDMI_C1!=CInput_Nothing)||(CInput_DVI_C1!=CInput_Nothing)
#define hwDVI0Cable_Pin                 (_bit0_(MEM_MSREAD_BYTE(_REG_GPIO3_IN)))
#define Init_hwDVI0Cable_Pin()          (MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, 1, BIT0)) // Enable SAR ch
...
#if InputType_HDMI
#define hwHDMICable_Pin      !hwDVI0Cable_Pin
#define Init_hwHDMICable_Pin()   Init_hwDVI0Cable_Pin() // input enable
#endif
...
#define hw_SetMute()                    (MEM_MSWRITE_BIT(_REG_GPIO0_OUT, FALSE, BIT1))
#define hw_ClrMute()                     (MEM_MSWRITE_BIT(_REG_GPIO0_OUT, TRUE, BIT1))
#define Init_hwMute_Pin()             (MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, FALSE, BIT1))
#else
#define hwMute_Pin                      //NO_USE_PIN
#define hw_SetMute()                    (MEM_MSWRITE_BIT(_REG_GPIO0_OUT, TRUE, BIT1))
#define hw_ClrMute()                     (MEM_MSWRITE_BIT(_REG_GPIO0_OUT, FALSE, BIT1))
#define Init_hwMute_Pin()             (MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, FALSE, BIT1))
#endif
...
#define hw_Set_Power_Standby()       
#define hw_Clr_Power_Standby()        
#define Init_hw_Power_Standby()	     

#if IR_FUNC_EN	//20130824
#define IR_DataKey                  (_bit7_(MEM_MSREAD_BYTE(_REG_GPIOSAR_IN)))   //-------
#define Init_IR_DataKey_Pin()          (MEM_MSWRITE_BIT(_REG_GPIOSAR_OEZ, 1, BIT3))
#endif
...
//DVI  I2C
#define Init_DVI_I2C_SCL_Pin()      (MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, TRUE, BIT2))
#define Init_DVI_I2C_SDA_Pin()     (MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, TRUE, BIT3))

#define Set_DVI_i2c_SDA()      		(MEM_MSWRITE_BIT(_REG_GPIO3_OUT, TRUE, BIT3),MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, TRUE, BIT3))
#define Clr_DVI_i2c_SDA()       	(MEM_MSWRITE_BIT(_REG_GPIO3_OUT, FALSE, BIT3), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, FALSE, BIT3))
#define DVI_i2c_SDA_IS_HI()     	(_bit3_(MEM_MSREAD_BYTE(_REG_GPIO3_IN)))
#define DVI_i2c_SDA_IS_LO()     	(!NVRAM_i2c_SDA_IS_HI())

#define Set_DVI_i2c_SCL()       	( MEM_MSWRITE_BIT(_REG_GPIO3_OUT, TRUE, BIT2),MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, TRUE, BIT2))
#define Clr_DVI_i2c_SCL()       		(MEM_MSWRITE_BIT(_REG_GPIO3_OUT, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, FALSE, BIT2))
#define DVI_i2c_SCL_IS_HI()     	(_bit2_(MEM_MSREAD_BYTE(_REG_GPIO3_IN)))
...
#define Set_HDMI_i2c_SDA()			(MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, TRUE, BIT5))
...
#define Set_HDMI_i2c_SCL()			(MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, TRUE, BIT4))
...
#else//dvi+hdmi
#define Set_NVRAM_i2c_SDA()      		((EnableReadDDCType==I2C_EEPROM)?Set_EEPROM_i2c_SDA():((EnableReadDDCType==DVI_EDID)?Set_DVI_i2c_SDA():Set_HDMI_i2c_SDA()))
#define Clr_NVRAM_i2c_SDA()       		((EnableReadDDCType==I2C_EEPROM)?Clr_EEPROM_i2c_SDA():((EnableReadDDCType==DVI_EDID)?Clr_DVI_i2c_SDA():Clr_HDMI_i2c_SDA()))
#define NVRAM_i2c_SDA_IS_HI()     	((EnableReadDDCType==I2C_EEPROM)?EEPROM_i2c_SDA_IS_HI():((EnableReadDDCType==DVI_EDID)?DVI_i2c_SDA_IS_HI():HDMI_i2c_SDA_IS_HI()))
#define NVRAM_i2c_SDA_IS_LO()     	(!NVRAM_i2c_SDA_IS_HI())

#define Set_NVRAM_i2c_SCL()       		((EnableReadDDCType==I2C_EEPROM)?Set_EEPROM_i2c_SCL():((EnableReadDDCType==DVI_EDID)?Set_DVI_i2c_SCL():Set_HDMI_i2c_SCL()))
#define Clr_NVRAM_i2c_SCL()       		((EnableReadDDCType==I2C_EEPROM)?Clr_EEPROM_i2c_SCL():((EnableReadDDCType==DVI_EDID)?Clr_DVI_i2c_SCL():Clr_HDMI_i2c_SCL()))
#define NVRAM_i2c_SCL_IS_HI()     	((EnableReadDDCType==I2C_EEPROM)?EEPROM_i2c_SCL_IS_HI():((EnableReadDDCType==DVI_EDID)?DVI_i2c_SCL_IS_HI():HDMI_i2c_SCL_IS_HI()))
#define NVRAM_i2c_SCL_IS_LO()     	(!NVRAM_i2c_SCL_IS_HI())
#endif
...
#else
//dvi
#define hw_Set_HdcpHpd2()       (MEM_MSWRITE_BIT(_REG_GPIO3_OUT, TRUE, BIT7), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, TRUE, BIT7))
#define hw_Clr_HdcpHpd2()       (MEM_MSWRITE_BIT(_REG_GPIO3_OUT, FALSE, BIT7), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, FALSE, BIT7))
#define Init_hwHDCP_Hpd_Pin2()  (MEM_MSWRITE_BIT(_REG_GPIO3_OUT, FALSE, BIT7), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, FALSE, BIT7))
//hdmi
#define hw_Set_HdcpHpd()       (MEM_MSWRITE_BIT(_REG_GPIO3_OUT, TRUE, BIT1), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, TRUE, BIT1), MEM_MSWRITE_BIT(REG_0262, TRUE, BIT2), MEM_MSWRITE_BIT(REG_0265, TRUE, BIT3))
#define hw_Clr_HdcpHpd()       (MEM_MSWRITE_BIT(_REG_GPIO3_OUT, FALSE, BIT1), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, FALSE, BIT1), MEM_MSWRITE_BIT(REG_0262, TRUE, BIT2), MEM_MSWRITE_BIT(REG_0265, FALSE, BIT3))
#define Init_hwHDCP_Hpd_Pin()  (MEM_MSWRITE_BIT(_REG_GPIO3_OUT, FALSE, BIT1), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, FALSE, BIT1), MEM_MSWRITE_BIT(REG_0262, TRUE, BIT2), MEM_MSWRITE_BIT(REG_0265, FALSE, BIT3)) //default low

//DP
#define hw_Set_HdcpHpd3()           (MEM_MSWRITE_BIT(_REG_GPIO5_OUT, TRUE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO5_OEZ, TRUE, BIT2))//, MEM_MSWRITE_BIT(REG_0262, FALSE, BIT3), MEM_MSWRITE_BIT(REG_0265, TRUE, BIT4))
#define hw_Clr_HdcpHpd3()            (MEM_MSWRITE_BIT(_REG_GPIO5_OUT, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO5_OEZ, FALSE, BIT2))//, MEM_MSWRITE_BIT(REG_0262, FALSE, BIT3), MEM_MSWRITE_BIT(REG_0265, FALSE, BIT4))
#define Init_hwHDCP_Hpd_Pin3()   (MEM_MSWRITE_BIT(_REG_GPIO5_OUT, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO5_OEZ, FALSE, BIT2))//, MEM_MSWRITE_BIT(REG_0262, FALSE, BIT3), MEM_MSWRITE_BIT(REG_0265, FALSE, BIT4)) //default low
...
// MHL PS_CTRL
#define SET_MHL_PS_CTRL_CHARGE0()    (MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, FALSE, BIT1), MEM_MSWRITE_BIT(_REG_GPIO2_OUT, TRUE, BIT1))
