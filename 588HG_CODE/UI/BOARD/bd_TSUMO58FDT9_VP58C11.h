...
#define INIT_HW_HarphoneDet_PIN()    	( MEM_MSWRITE_BIT(_REG_GPIOL_OEZ_H, BIT1, BIT1),MEM_MSWRITE_BIT(_REG_GPIOL_SEL_H, 0, BIT1))
#define HarphoneDet_Pin                             (_bit1_(msReadByte(_REG_GPIOL_IN_H)))
#endif
//================================================================================================================
...
#else
#define hwDSUBCable_Pin                 (_bit1_(MEM_MSREAD_BYTE(_REG_GPIO5_IN)))  //SAR3
#define Init_hwDSUBCable_Pin()          (MEM_MSWRITE_BIT(_REG_GPIO5_OEZ, 1, BIT1))
