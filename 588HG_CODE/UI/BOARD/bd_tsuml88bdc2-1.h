...
// GPIO20 <--swap-->  GPIO21, in this board!!
...
#if (CInput_HDMI_C1!=CInput_Nothing)||(CInput_DVI_C1!=CInput_Nothing)   // Digital Input Port A
#define hwDVI0Cable_Pin                 (_bit7_(MEM_MSREAD_BYTE(_REG_GPIO3_IN)))    //GPTO37
#define Init_hwDVI0Cable_Pin()          (MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, 1, BIT7))  // Enable GPIO37 Input
...
#if (CInput_HDMI_C2!=CInput_Nothing)||(CInput_DVI_C2!=CInput_Nothing)   // Digital Input Port B
#define hwDVI1Cable_Pin                 (_bit0_(MEM_MSREAD_BYTE(_REG_GPIO3_IN)))    //GPIO30
#define Init_hwDVI1Cable_Pin()          (MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, 1, BIT0))  // Enable GPIO30 Input
...
#define hw_SetGreenLed()                {MEM_MSWRITE_BIT(_REG_GPIO2_OEZ,0,BIT4);MEM_MSWRITE_BIT(_REG_GPIO2_OUT,1,BIT4);}
#define hw_ClrGreenLed()                {MEM_MSWRITE_BIT(_REG_GPIO2_OEZ,0,BIT4);MEM_MSWRITE_BIT(_REG_GPIO2_OUT,0,BIT4);}
#define Init_hwGreenLed_Pin()           MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, 0,BIT4)// output enable

#define hw_SetAmberLed()                {MEM_MSWRITE_BIT(_REG_GPIO2_OEZ,0,BIT5);MEM_MSWRITE_BIT(_REG_GPIO2_OUT, 0, BIT5);}
#define hw_ClrAmberLed()                {MEM_MSWRITE_BIT(_REG_GPIO2_OEZ,0,BIT5);MEM_MSWRITE_BIT(_REG_GPIO2_OUT, 1, BIT5);}
...
//================================================================================================================
// I2C
#ifdef UseVGACableReadWriteAllPortsEDID//&&!defined(UseInternalDDCRam)
