...
#define hw_SetBlacklit()    {MEM_MSWRITE_BIT(_REG_GPIO0_OUT, 1, BIT5); BackLightActiveFlag=1;}
#define hw_ClrBlacklit()    {MEM_MSWRITE_BIT(_REG_GPIO0_OUT, 0, BIT5); BackLightActiveFlag=0;}
