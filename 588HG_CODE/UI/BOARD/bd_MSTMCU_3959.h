...
//========================================================
// 1.Write protection:
#define hwDDC_WP_Pin           NonUsepin
#define hwEEPROM_WP                NonUsepin
#define hwFlash_WP_Pin         P2_7

#ifndef SCALAR_IO
#define SCALAR_IO
#endif
#define hw_ClrDDC_WP()      (SetScalerGPIO(6, 1))
#define hw_SetDDC_WP()      (SetScalerGPIO(6, 0))
...
//========================================================
// 4.Detect Cable
#define hwDSUBCable_Pin        P1_7
#define hwDVICable_Pin      NonUsepin
