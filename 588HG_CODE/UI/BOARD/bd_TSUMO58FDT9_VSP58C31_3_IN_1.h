#ifndef __BD_TSUMO58FDT9_VSP58C31_3_IN_1_H__
#define __BD_TSUMO58FDT9_VSP58C31_3_IN_1_H__
...
#define DFT_MUX_Uart0           UART0_GPIO40_41 // UART0_GPIO40_41  // UART0_GPIO34_35   //    default mux uart 0 - VGA
...
#endif
#define PowerKey                     (_bit4_(MEM_MSREAD_BYTE(_REG_GPIOSAR_IN)))   //---tang
...
//130708 petit
#define hw_SetDDC_WP()          MEM_MSWRITE_BIT(_REG_GPIO2_OUT, 1, BIT1)       // HDMI-DDC
#define hw_ClrDDC_WP()           MEM_MSWRITE_BIT(_REG_GPIO2_OUT, 0, BIT1)
#define Init_hwDDC_WP_Pin()   MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, 0, BIT1)   
...
#define hw_SetStandbyOn()         //MEM_MSWRITE_BIT(_REG_GPIOL_OUT_H, 1, BIT2)
#define hw_ClrStandbyOn()         //MEM_MSWRITE_BIT(_REG_GPIOL_OUT_H, 0, BIT2)
#define Init_hwStandby_WP_Pin()   //MEM_MSWRITE_BIT(_REG_GPIOL_OEZ_H, 0, BIT2)
...
#else
#define hwDSUBCable_Pin                 (_bit5_(MEM_MSREAD_BYTE(_REG_GPIO5_IN)))  //SAR3
...
#define hwDVI0Cable_Pin                 (_bit7_(MEM_MSREAD_BYTE(_REG_GPIO2_IN)))
#define Init_hwDVI0Cable_Pin()          (MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, 1, BIT7)) // Enable SAR ch
...
#define hwDVI1Cable_Pin                 //(KEYPAD_SAR6)
#define Init_hwDVI1Cable_Pin()        //  (MEM_MSWRITE_BIT(REG_3A68,1,BIT6)) // Enable SAR ch
#define CABLE_DET_DVI1_SAR           //   SAR6_EN
#else
...
#define hw_ClrGreenLed()                   {MEM_MSWRITE_BIT(_REG_GPIO2_OEZ,0,BIT2);MEM_MSWRITE_BIT(_REG_GPIO2_OUT,0,BIT2);}// MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, 1,BIT2)
...
#define Init_NVRAM_I2C_SCL_Pin()        {Init_VGA_I2C_SCL_Pin();Init_DVI_I2C_SCL_Pin();}
#define Init_NVRAM_I2C_SDA_Pin()       {Init_VGA_I2C_SDA_Pin();Init_DVI_I2C_SDA_Pin();}
...
#if 0//vga+dvi+hdmi
#define Set_NVRAM_i2c_SDA()      		((EnableReadDDCType==VGA_EDID)?Set_VGA_i2c_SDA():((EnableReadDDCType==DVI_EDID)?Set_DVI_i2c_SDA():Set_HDMI_i2c_SDA()))
#define Clr_NVRAM_i2c_SDA()       		((EnableReadDDCType==VGA_EDID)?Clr_VGA_i2c_SDA():((EnableReadDDCType==DVI_EDID)?Clr_DVI_i2c_SDA():Clr_HDMI_i2c_SDA()))
#define NVRAM_i2c_SDA_IS_HI()     	((EnableReadDDCType==VGA_EDID)?VGA_i2c_SDA_IS_HI():((EnableReadDDCType==DVI_EDID)?DVI_i2c_SDA_IS_HI():HDMI_i2c_SDA_IS_HI()))
#define NVRAM_i2c_SDA_IS_LO()     	(!NVRAM_i2c_SDA_IS_HI())

#define Set_NVRAM_i2c_SCL()       		((EnableReadDDCType==VGA_EDID)?Set_VGA_i2c_SCL():((EnableReadDDCType==DVI_EDID)?Set_DVI_i2c_SCL():Set_HDMI_i2c_SCL()))
#define Clr_NVRAM_i2c_SCL()       		((EnableReadDDCType==VGA_EDID)?Clr_VGA_i2c_SCL():((EnableReadDDCType==DVI_EDID)?Clr_DVI_i2c_SCL():Clr_HDMI_i2c_SCL()))
#define NVRAM_i2c_SCL_IS_HI()            ((EnableReadDDCType==VGA_EDID)?VGA_i2c_SCL_IS_HI():((EnableReadDDCType==DVI_EDID)?DVI_i2c_SCL_IS_HI():HDMI_i2c_SCL_IS_HI()))
#define NVRAM_i2c_SCL_IS_LO()     	(!NVRAM_i2c_SCL_IS_HI())
#else//vga+hdmi
#define Set_NVRAM_i2c_SDA()      		((EnableReadDDCType==VGA_EDID)?Set_VGA_i2c_SDA():Set_DVI_i2c_SDA())
#define Clr_NVRAM_i2c_SDA()       		((EnableReadDDCType==VGA_EDID)?Clr_VGA_i2c_SDA():Clr_DVI_i2c_SDA())
#define NVRAM_i2c_SDA_IS_HI()     	((EnableReadDDCType==VGA_EDID)?VGA_i2c_SDA_IS_HI():DVI_i2c_SDA_IS_HI())
#define NVRAM_i2c_SDA_IS_LO()     	(!NVRAM_i2c_SDA_IS_HI())

#define Set_NVRAM_i2c_SCL()       		((EnableReadDDCType==VGA_EDID)?Set_VGA_i2c_SCL():Set_DVI_i2c_SCL())
#define Clr_NVRAM_i2c_SCL()       		((EnableReadDDCType==VGA_EDID)?Clr_VGA_i2c_SCL():Clr_DVI_i2c_SCL())
#define NVRAM_i2c_SCL_IS_HI()            ((EnableReadDDCType==VGA_EDID)?VGA_i2c_SCL_IS_HI():DVI_i2c_SCL_IS_HI())
#define NVRAM_i2c_SCL_IS_LO()     	(!NVRAM_i2c_SCL_IS_HI())
#endif
...
#else
//dvi
#define hw_Set_HdcpHpd2()       (MEM_MSWRITE_BIT(_REG_GPIO3_OUT, TRUE, BIT6), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, TRUE, BIT6))
#define hw_Clr_HdcpHpd2()       (MEM_MSWRITE_BIT(_REG_GPIO3_OUT, FALSE, BIT6), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, FALSE, BIT6))
#define Init_hwHDCP_Hpd_Pin2()  (MEM_MSWRITE_BIT(_REG_GPIO3_OUT, FALSE, BIT6), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, FALSE, BIT6))
//hdmi
