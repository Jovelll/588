...
#define BACKLIGHT_PWM_FREQ                  240//240         //unit:Hz
...
#define hwDVI0Cable_Pin                 (!_bit2_(MEM_MSREAD_BYTE(_REG_GPIO0_IN)))
#define Init_hwDVI0Cable_Pin()          (MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, TRUE, BIT2)) //
...
//================================================================================================================
// 5.Led
#define hwGreenLed_Pin                  // GPIO20
#define hwAmberLed_Pin                  // GPIO22

#define hw_SetGreenLed()                {MEM_MSWRITE_BIT(_REG_GPIO2_OEZ,0,BIT0);MEM_MSWRITE_BIT(_REG_GPIO2_OUT,1,BIT0);}
#define hw_ClrGreenLed()                {MEM_MSWRITE_BIT(_REG_GPIO2_OEZ,0,BIT0);MEM_MSWRITE_BIT(_REG_GPIO2_OUT,0,BIT0);}
#define Init_hwGreenLed_Pin()           MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, 0,BIT0)// output enable
