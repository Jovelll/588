#ifndef __BD_TSUMO58FDT9_1A3C__
#define __BD_TSUMO58FDT9_1A3C__
...
#define hw_SetBlacklit()        (MEM_MSWRITE_BIT(_REG_GPIOL_OUT_H, 1, BIT2), BackLightActiveFlag=1)
#define hw_ClrBlacklit()        (MEM_MSWRITE_BIT(_REG_GPIOL_OUT_H, 0, BIT2), BackLightActiveFlag=0)
...
#define hwDVI0Cable_Pin                 (KEYPAD_SAR6)
...
#endif
#if ENABLE_DP_INPUT			   //GPIO36 = Port A, GPIO31 = Port B	  ( GPIO36 = Port A)
#define Init_hwDP_Hpd_Pin0()   (MEM_MSWRITE_BIT(_REG_GPIO3_OUT, FALSE, BIT6),MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, FALSE, BIT6), MEM_MSWRITE_BIT(REG_0262, TRUE, BIT3))
#define hw_Set_DPHpd0()           (MEM_MSWRITE_BIT(_REG_GPIO3_OUT, TRUE, BIT6),MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, FALSE, BIT6), MEM_MSWRITE_BIT(REG_0262, TRUE, BIT3))
#define hw_Clr_DPHpd0()            (MEM_MSWRITE_BIT(_REG_GPIO3_OUT, FALSE, BIT6), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, FALSE, BIT6)) //default high

#define hw_Set_DPCable5V()           (MEM_MSWRITE_BIT(_REG_GPIOL_OUT_H, TRUE, BIT3),MEM_MSWRITE_BIT(_REG_GPIOL_OEZ_H, FALSE, BIT3), MEM_MSWRITE_BIT(_REG_GPIOL_SEL_H, TRUE, BIT3))
#define hw_Clr_DPCable5V()           (MEM_MSWRITE_BIT(_REG_GPIOL_OUT_H, FALSE, BIT3), MEM_MSWRITE_BIT(_REG_GPIOL_OEZ_H, FALSE, BIT3)) //default high
...
#else
#define hw_Set_HdcpHpd()        (MEM_MSWRITE_BIT(_REG_GPIO3_OUT, TRUE, BIT6), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, FALSE, BIT6), MEM_MSWRITE_BIT(REG_0262, TRUE, BIT3), MEM_MSWRITE_BIT(REG_0265, TRUE, BIT4))
...
#define hw_Set_HdcpHpd2()       (MEM_MSWRITE_BIT(_REG_GPIO3_OUT, TRUE, BIT1), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, FALSE, BIT1), MEM_MSWRITE_BIT(REG_0262, TRUE, BIT2), MEM_MSWRITE_BIT(REG_0265, TRUE, BIT3))
...
#define hw_Set_HdcpHpd3()       (MEM_MSWRITE_BIT(_REG_GPIO5_OUT, TRUE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO5_OEZ, FALSE, BIT2), MEM_MSWRITE_BIT(REG_0262, FALSE, BIT5), MEM_MSWRITE_BIT(REG_0265, TRUE, BIT5))
