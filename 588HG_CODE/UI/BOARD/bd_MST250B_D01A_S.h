...
#define BrightnessPWM          _PWM0_

#define Init_BrightnessPWM()    {MEM_MSWRITE_BYTE_MASK(REG_0280,BIT0,BIT0);}///{ MEM_MSWRITE_BYTE_MASK(REG_1B09,BIT5,BIT5);}//MEM_MSWRITE_BYTE_MASK(REG_0280,BIT5,BIT5);}
...
#define PowerKey               (MEM_MSREAD_BYTE(REG_3A20))
...
#define hw_SetBlacklit()    (MEM_MSWRITE_BIT(_REG_PMGPIO0_OUT, 1, BIT4), BackLightActiveFlag=1)
#define hw_ClrBlacklit()    (MEM_MSWRITE_BIT(_REG_PMGPIO0_OUT, 0, BIT4), BackLightActiveFlag=0)
#define Init_hwBlacklit_Pin()   MEM_MSWRITE_BIT(_REG_PMGPIO0_OEZ, 0, BIT4) // output enable

#define hw_SetPanel()       MEM_MSWRITE_BIT(_REG_PMGPIO2_OUT, 1, BIT6)
#define hw_ClrPanel()       MEM_MSWRITE_BIT(_REG_PMGPIO2_OUT, 0, BIT6)//(_REG_GPIO1_OUT, 0, BIT2)
#define Init_hwPanel_Pin()  MEM_MSWRITE_BIT(_REG_PMGPIO2_OEZ, 0, BIT6) // output enable
//========================================================
