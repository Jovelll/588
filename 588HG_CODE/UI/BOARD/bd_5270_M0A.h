...
#define DOUBLE_LVDS_CLK_SWING   PanelDualPort
...
#define Init_VolumePWM()    ( MEM_MSWRITE_BYTE_MASK(REG_0225,BIT7,BIT7),MEM_MSWRITE_BYTE_MASK(REG_0280,BIT2,BIT2))
#endif
...
#define hw_SetDDC_WP()      (MEM_MSWRITE_BIT(_REG_PMGPIO1_OEZ, 1, BIT6),DDCWPActiveFlag=1)
#define hw_ClrDDC_WP()      (MEM_MSWRITE_BIT(_REG_PMGPIO1_OUT, 0, BIT6), MEM_MSWRITE_BIT(_REG_PMGPIO1_OEZ, 0, BIT6),DDCWPActiveFlag=0)
...
// 20111014.  Gary.Wang. Annie follow KL 1013 comment
#define hw_SetGreenLed()            (MEM_MSWRITE_BIT(_REG_PMGPIO0_OUT,0,BIT1))
#define hw_ClrGreenLed()            (MEM_MSWRITE_BIT(_REG_PMGPIO0_OUT,1,BIT1))
...
// 6.Audio control:
#define hwMute_Pin             
#define hw_SetMute()            		(MEM_MSWRITE_BIT(_REG_GPIO0_OUT, 0, BIT1))
#define hw_ClrMute()        			(MEM_MSWRITE_BIT(_REG_GPIO0_OUT, 1, BIT1))
#define Init_hwMute_Pin()			(MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, 0, BIT1))
