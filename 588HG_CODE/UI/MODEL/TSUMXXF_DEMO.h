...
//#define MainBoardType          MainBoard_TSUMO58FDT9_1A3C///MainBoard_TSUMP589HT9_DP//MainBoard_TSUMO58FMG_H_///MainBoard_TSUMO58FMG_H_/////MainBoard_TSUMP589HT9_DP
#define ENABLE_XTAL_LESS                0
#define ENABLE_XTAL_LESS_FPLL           (1 && ENABLE_XTAL_LESS)     // Note: FPLL will stay disabled when the input is DP
#define ENABLE_XTAL_LESS_SW_SLT         (1 && ENABLE_XTAL_LESS)
#define ENABLE_RESET_PIN                0
#define ENABLE_CABLE_5V_EDID            0			//InternalEDID flag
...
#define ENABLE_LED_CONTROLLER           0
#define _NEW_SOG_DET_                   0
#elif MainBoardType == MainBoard_TSUMO58FDT9_VP58C41_B  // 128 pins 1A1HDMI
#define INPUT_TYPE                      INPUT_1A1H
#define ENABLE_HDMI                     1       //((Input_HDMI_C1 != Input_Nothing)||(Input_HDMI_C2 != Input_Nothing)||(Input_HDMI_C3 != Input_Nothing))
#define ENABLE_HDMI_1_4                 0
#define ENABLE_MHL_C1                   0
...
#define ENABLE_LED_CONTROLLER           0
#define _NEW_SOG_DET_                   0
#elif MainBoardType == MainBoard_TSUMP589MG_H // new board 72 pins
#define INPUT_TYPE                      INPUT_1A1C2
#define ENABLE_HDMI                     1       //((Input_HDMI_C1 != Input_Nothing)||(Input_HDMI_C2 != Input_Nothing)||(Input_HDMI_C3 != Input_Nothing))
#define ENABLE_HDMI_1_4                 0
#define ENABLE_MHL_C1                   0
...
#else
//#define PanelType                   PanelBOEMV238FHM_N30//PanelM185BGE_L22 // //PanelAUOM238HVN01 
#endif
...
#define BRIGHTNESS_INVERSE              1//0
#define BRIGHTNESS_FREQ                 20000//240 // unit: Hz
